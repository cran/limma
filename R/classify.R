...
#	Gordon Smyth
#	17 Aug 2004. Last modified 25 April 2005.
{
...
#classifyTestsF0 <- function(object,cor.matrix=NULL,design=NULL,contrasts=diag(ncol(design)),df=Inf,p.value=0.01,fstat.only=FALSE) {
##	Use F-tests to classify vectors of t-test statistics into outcomes
##	Gordon Smyth
##	20 Mar 2003.  Last revised 1 June 2004.
#
##	Method intended for MAList objects but accept unclassed lists as well
#	if(is.list(object)) {
#		if(is.null(object$t)) stop("tstat cannot be extracted from object")
